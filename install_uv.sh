...
TORCHAUDIO_VERSION="${TORCHAUDIO_VERSION:-2.12.0}"
INSTALL_TORCHAUDIO="${INSTALL_TORCHAUDIO:-0}"
PYTORCH_CUDA_FLAVOR="${PYTORCH_CUDA_FLAVOR:-cu132}"
...
echo "Modes:"
echo "  USE_SYSTEM_TORCH=0 bash install_uv.sh   # default, installs torch/cu132 into ${VENV_DIR}"
